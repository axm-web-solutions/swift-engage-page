  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <a
          href={`https://wa.me/34624574029?text=${encodeURIComponent(service.whatsapp)}`}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 bg-garden-gradient text-primary-foreground font-body font-bold text-sm px-5 py-2.5 rounded-full hover:opacity-90 transition-opacity"
        >
